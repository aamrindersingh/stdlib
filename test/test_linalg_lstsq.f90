...
module test_linalg_least_squares
    ...
    subroutine test_solve_generalized_lstsq_s(error)
        ...
        ! SPD covariance matrix
        W(1,:) = [2.0_sp, 1.0_sp, 0.5_sp, 0.25_sp]
        W(2,:) = [1.0_sp, 2.0_sp, 1.0_sp, 0.5_sp]
        W(3,:) = [0.5_sp, 1.0_sp, 2.0_sp, 1.0_sp]
        W(4,:) = [0.25_sp, 0.5_sp, 1.0_sp, 2.0_sp]
    ...
    subroutine test_solve_generalized_lstsq_d(error)
        ...
        ! SPD covariance matrix
        W(1,:) = [2.0_dp, 1.0_dp, 0.5_dp, 0.25_dp]
        W(2,:) = [1.0_dp, 2.0_dp, 1.0_dp, 0.5_dp]
        W(3,:) = [0.5_dp, 1.0_dp, 2.0_dp, 1.0_dp]
        W(4,:) = [0.25_dp, 0.5_dp, 1.0_dp, 2.0_dp]
